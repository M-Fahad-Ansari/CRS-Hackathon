...
import { register, registerOnFirebase, registerFail } from "../store/actions/action"
    ...
    Email:<br/><input className="form-control" type="email" ref="email"/> <br />
     Password:<br/><input className="form-control" type="password" ref="pass"/><br/>
      <div className="radioButton" onChange={this.setUser.bind(this)}>
        ...
        <input type="radio" value="company" name="user"/> Company <br/>
        <input type="radio" value="admin" name="user"/> Admin <br/>

      </div>
    <center><button  onClick={this.signUp.bind(this)}>Sign Up</button></center>
    </form> 
    </div>
        )
    }
